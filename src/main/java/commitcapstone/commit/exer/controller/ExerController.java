...
public class ExerController {
    ...
    @GetMapping("time")
    public ResponseEntity<SuccessResponse<UserExerTimeStatResponse>> getTotalTime(@AuthenticationPrincipal String email) {
        UserExerTimeStatResponse response = exerService.getExerTime(email);
